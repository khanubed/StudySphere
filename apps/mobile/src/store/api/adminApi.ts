...
export interface MobileAdminUserListItem extends UserProfile {
  isVerified: boolean;
  isActive: boolean;
}

export interface MobileContentModerationItem {
  id: string;
  resource: Resource;
  reason?: string;
  flaggedBy?: string;
...
export interface MobilePlanConfig {
  id: string;
...
export const adminApi = baseApi.injectEndpoints({
  endpoints: (builder) => ({
    getAdminUsers: builder.query<
      ApiResponse<PaginatedResponse<MobileAdminUserListItem>>,
    ...
    getModerationQueue: builder.query<
      ApiResponse<PaginatedResponse<MobileContentModerationItem>>,
